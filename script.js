...
fieldBgImg.src = "imagem/campo_cidade.jpeg";
const tractorImg = new Image();
tractorImg.src = "imagem/Cópia de trator.webp";
const productImg = new Image();
productImg.src = "imagem/Cópia de milho.png";
const fuelImg = new Image();
fuelImg.src = "imagem/gasolina.png";
const marketImg = new Image();
marketImg.src = "imagem/mercado.webp";
const clockImg = new Image();
clockImg.src = "imagem/relogio.png";
const cityBgImg = new Image();
cityBgImg.src = "imagem/campo e cidade.jpeg";
...
function draw() {
  ...
  // Cenário por fase
 if (phase === 1) {
  ctx.fillStyle = "#ffe0b2"; ctx.fillRect(0, 0, canvas.width, 200);
  ctx.fillStyle = "#a5d6a7"; ctx.fillRect(0, 200, canvas.width, 300);
} else {
  ...
  for (let ob of obstacles) ctx.fillRect(ob.x, ob.y, ob.width, ob.height);
